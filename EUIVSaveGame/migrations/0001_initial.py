    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('savegame_name', models.CharField(db_index=True, default=uuid.UUID('4012c80e-cb9d-4d5d-addb-a58989b544fe'), help_text='The name of the savegame to use.', max_length=50, unique=True, verbose_name='Savegame name')),
                ...
                ('hits_until_end_of_streaming', models.IntegerField(default=3, help_text='The number of savegame process without changes until the end of stream.', validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(10)], verbose_name='Record max hits')),
